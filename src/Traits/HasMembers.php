...
trait HasMembers
{
     ...
     * @throws Exception
     */
    public function getRole(int|string $keyword): ?object
    {
     ...
     * @throws Exception
     */
    public function updateRole(int|string $keyword, array $permissions, ?string $name = null, ?string $description = null): object|bool
    {
